...
define OPENSSH_ALLOW_X11_FORWARDING
	$(SED) 's/\#X11Forwarding no/X11Forwarding yes/' $(TARGET_DIR)/etc/ssh/sshd_config
endef

OPENSSH_POST_INSTALL_TARGET_HOOKS += OPENSSH_INSTALL_SSH_COPY_ID
OPENSSH_POST_INSTALL_TARGET_HOOKS += OPENSSH_ALLOW_X11_FORWARDING
